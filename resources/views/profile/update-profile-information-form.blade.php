...
<div class="col-span-6 sm:col-span-4">
    ...
    <select id="gender" class="mt-1 block w-full" wire:model.defer="state.gender">
...
<div class="col-span-6 sm:col-span-4">
    ...
    <select id="bloodgroup" class="mt-1 block w-full" wire:model.defer="state.bloodgroup">
    ...
    <x-input-error for="bloodgroup" class="mt-2" />
</div>
    </x-slot>
